package com.skay.imusic.service;
...
import com.skay.imusic.glide.BlurTransformation;
import com.skay.imusic.glide.SongGlideRequest;
import com.skay.imusic.model.Song;
import com.skay.imusic.model.helper.ShuffleHelper;
import com.skay.imusic.model.helper.StopWatch;
import com.skay.imusic.provider.MusicPlaybackQueueStore;
import com.skay.imusic.provider.SongPlayCountStore;
import com.skay.imusic.service.notification.PlayingNotification;
import com.skay.imusic.service.notification.PlayingNotificationImpl;
import com.skay.imusic.service.notification.PlayingNotificationImpl24;
import com.skay.imusic.service.playback.Playback;
import com.skay.imusic.util.MusicUtil;
import com.skay.imusic.util.PreferenceUtil;
import com.skay.imusic.util.Util;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "com.skay.imusic" + ".temp_sticky_intent_fix"; // TODO remove ".temp_sticky_intent_fix" in a future update.
    ...
    private OnChangeVolumeListener mOnChangeVolumeListener;
    ...
    private final BroadcastReceiver volumeChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            mOnChangeVolumeListener.onChangeVolumeListener();
        }
    };
    ...
    public void setChangeVolumeListener(OnChangeVolumeListener mOnChangeVolumeListener) {
        this.mOnChangeVolumeListener = mOnChangeVolumeListener;
    }
